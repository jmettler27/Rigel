...
class MyPlanetModelTest {
    ...
    void atWorksOnJupiterExample() {
        ...
        Planet jupiter = PlanetModel.JUPITER.at(-2231.0, eclipticToEquatorialConversion);
         ...
         *
         * Ne = 321.0119519493011 degrees       ==> correct
        ...
        assertEquals((11.0 + 11.0 / 60.0 + 14.0 / 3600.0), jupiter.equatorialPos().raHr(), 1.0 / 3600.0);
        ...
        assertEquals(Angle.ofDMS(6, 21, 25), jupiter.equatorialPos().dec(), 1e-5);
    }

    @Test
    void atWorksOnMercuryExample() {
        // Book p. 128 : Mercury's right ascension and declination on 22 November 2003
        Planet mercury = PlanetModel.MERCURY.at(-2231.0, eclipticToEquatorialConversion);
        ...
        assertEquals((16.0 + 49.0 / 60.0 + 12.0 / 3600.0), mercury.equatorialPos().raHr(), 1.0 / 3600.0);
        ...
        assertEquals(Angle.ofDMS(-24, 30, 9), mercury.equatorialPos().dec(), 1e-1);
    }
}